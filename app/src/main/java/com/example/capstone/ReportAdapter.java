...
public class ReportAdapter extends RecyclerView.Adapter<ReportAdapter.CustomViewHolder>{
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(@NonNull View itemView) {
            ...
            this.title = (TextView) itemView.findViewById(R.id.rTitle);
            this.date = (TextView) itemView.findViewById(R.id.rDate);
            this.nname = (TextView) itemView.findViewById(R.id.rNname);
        }
    }
